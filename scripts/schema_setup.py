...
def create_constraints_and_indexes(conn: Neo4jConnection, st_print=print):
    """
    ...
    """
    st_print("Setting up constraints and indexes...")
    ...
    for query in queries:
        st_print(f"Executing: {query}")
        conn.query(query)

    st_print("Constraints and indexes setup complete.")
